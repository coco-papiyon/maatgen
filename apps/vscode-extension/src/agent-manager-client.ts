export interface AgentSession { id: string; agent: string; workspace: string; workspaceKind: 'git_repository' | 'directory'; status: string; activeRunStatus?: string; createdAt: string; closedAt?: string; }
